...
import TherapistRegistrationFlow from './frontend/apps/therapist-registration-flow/TherapistRegistrationFlow';
import TherapistOnboardingApp from './frontend/apps/therapist-onboarding/App';
...
import PremiumHub from './integrations/payment-gateway/frontend/src/screens/PremiumHub';
import { Session } from './types';
import { storageService } from './utils/storageService';

import CBTApp from './frontend/apps/cbt-session-engine/CBTApp';
import MeeraApp from './frontend/apps/meera-ai-chatbot/MeeraApp';
import GroupSessionsApp from './frontend/apps/group-sessions/App';
import CertificationPlatform from './frontend/apps/certification-platform/CertificationApp';
import SchoolWellnessApp from './frontend/apps/school-wellness/App';
import CorporateWellnessApp from './frontend/apps/corporate-wellness/App';
...
const App: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {currentView === 'premium-hub' && <PremiumHub />}
